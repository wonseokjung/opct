...
export const protobufPackage = "cosmonaut.opctcoin.dex";
...
export class QueryClientImpl {
    ...
    SellOrderBook(request) {
        ...
        const promise = this.rpc.request("cosmonaut.opctcoin.dex.Query", "SellOrderBook", data);
    ...
    SellOrderBookAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.opctcoin.dex.Query", "SellOrderBookAll", data);
    ...
    BuyOrderBook(request) {
        ...
        const promise = this.rpc.request("cosmonaut.opctcoin.dex.Query", "BuyOrderBook", data);
    ...
    BuyOrderBookAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.opctcoin.dex.Query", "BuyOrderBookAll", data);
    ...
    DenomTrace(request) {
        ...
        const promise = this.rpc.request("cosmonaut.opctcoin.dex.Query", "DenomTrace", data);
    ...
    DenomTraceAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.opctcoin.dex.Query", "DenomTraceAll", data);
